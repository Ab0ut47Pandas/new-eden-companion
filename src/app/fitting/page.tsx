    ...
    <main className={styles.shell}>
      <div className={styles.container}>
        ...
        <section className={styles.hero}>
          ...
          <p>Build from the NEC validated resolved-Dogma catalog and watch fit legality and supported stats update immediately. The catalog is intentionally conservative: unsupported hulls, modules, effects, and charges stay unavailable or unknown rather than being guessed from item names.</p>
        </section>
