...
export const RECOMMENDED_EVE_SCOPES = [
  ...
  "esi-universe.read_structures.v1",
  "esi-wallet.read_character_wallet.v1",
] as const satisfies readonly (typeof EVE_SCOPES)[number][];

export const EVE_SCOPE_STRING = EVE_SCOPES.join(" ");
export const RECOMMENDED_EVE_SCOPE_STRING = RECOMMENDED_EVE_SCOPES.join(" ");
