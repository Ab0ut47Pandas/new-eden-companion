...
- Current work item: **MANUAL CHECKPOINT — HAU-02**
- Next implementation item after checkpoint: `IND-01`
- Last completed: `HAU-02`
- Last updated: 2026-08-19
- Test checkpoint result: ABY-01 through ABY-06 were manually exercised in the portable app. The first test exposed player-readability issues in the Abyssal guide; PR #54 corrected card interaction, character-skill fit checks, readiness wording, fit import/navigation, and loot teaching, and the fixes shipped in v0.1.14. HAU-02 is now paused for installed-app testing of automatic trade discovery, exact-depth cargo output, custom route comparison/avoidance, shortcut discoverability, and optional EVE waypoint writing before IND-01 begins; the exact checklist is in `docs/HAU_02_TRADE_RUN.md`.
