...
| Activity | NEC status | Notes |
| --- | --- | --- |
| Hauling your own cargo / logistics | ROADMAP | `HAU-01` makes hauling a first-class activity rather than only a dependency. |
...
| Courier contracts | GAP | Formal player-to-player hauling with reward, collateral, pickup and destination risk. `HAU-01` should introduce the hauling side. |
...
| Freelance delivery jobs | GAP | Current player-created logistics work introduced through Freelance Jobs. `HAU-01` should introduce the hauling side. |
...
| Military Campaigns | GAP | Current 2026 core system. Objectives span combat, mining, hacking, industry, hauling and Faction Warfare and should eventually integrate with Suggested Session and goal guidance. |
...
| Freelance Jobs | GAP | Current EVE system for player-created public work; ESI exposes public/character job data. |
